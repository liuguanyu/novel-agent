...
- [ ] 4.1 [Core/IPC] 定义完整 IPC 判别联合，精确区分 run/workflow/asset/request scope，并要求 requestId、operationId、expectedVersion、continuation 联合及 command failure
...
- [ ] 4.6 [IPC/Test] 覆盖精确 run/workflow/asset/request scope、requestId/operationId/expectedVersion、standalone 兼容、伪造归属、过期版本、重连查询、continuation 判别联合及契约测试
